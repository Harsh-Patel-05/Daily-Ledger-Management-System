...
import { weeklyReport, topCustomers, monthlyCollection } from '../data/analytics';
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'daily' && (
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader title="Daily Report — 03 Aug 2026" subtitle="All transactions for today" />
      ...
      {activeTab === 'weekly' && (
        <Card>
          <CardHeader title="Weekly Report" subtitle="Sales & collection this week" />
          <div className="h-80">
      ...
      {activeTab === 'monthly' && (
        <Card>
          <CardHeader title="Monthly Report" subtitle="Year-to-date overview" />
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
      ...
      {activeTab === 'collection' && (
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <StatCard title="Total Collection (YTD)" value={monthlyCollection.reduce((s, m) => s + m.collection, 0)} icon={FaHandHoldingUsd} color="green" />
            <StatCard title="Total Credit (YTD)" value={monthlyCollection.reduce((s, m) => s + m.credit, 0)} icon={FaFileAlt} color="blue" />
            <StatCard title="Avg Monthly Collection" value={Math.round(monthlyCollection.reduce((s, m) => s + m.collection, 0) / monthlyCollection.length)} icon={FaCalendarAlt} color="purple" />
          </div>
          <Card>
